...
router.post('/', function (req, res, next) {
	var songReqEvent = 19;
	var songQuery = "INSERT INTO requested_songs (user_id,device_id,song,album,artist,message) VALUES ?";
	var songValue = [[req.body.user_id, req.body.device_id, req.body.song, req.body.album, req.body.artist, req.body.message]];
	...
	if (dbName != null) {
		...
		onestation.query(songQuery, [songValue], function (err, result) {
			if (err) {
				onestation.end();
			} else {
